...
namespace bg {
	...
	static constexpr int OBS_EXTENDED_SCALARS_DIM = 17;
	...
	void get_obs_extended(const State& s, const Dice& d, int mine_score, int opp_score, int dave_value, float* out /*len=257*/);
